...
function clickPage(page){
	...
	$("#Content").load("${ctx}/bi/outsourceActualNumber/list",{pageNo:$("#PageNo").val(),pageSize:$("#PageSize").val(),
...
<table class="table table-condensed table-hover">
	<thead>
		<tr>
			...
			<th style="text-align: center;">廠區</th>
			<th style="text-align: center;">BU</th>
			<th style="text-align: center;">SBU</th>
			<th style="text-align: center;">外包成本</th>
			<th style="text-align: center;">場內自製成本</th>
			<th style="text-align: center;">廠區營收</th>
		</tr>
	</thead>
	<tbody>
		<c:forEach items="${page.result}" var="mapping">
			<tr>
				...
				<td style="border-right:1px solid #eee;text-align: center;">${mapping.factory}</td>
				...
				<td style="border-right:1px solid #eee;text-align: center;">${mapping.outsourceCost}</td>
				<td style="border-right:1px solid #eee;text-align: center;">${mapping.factoryCost}</td>
