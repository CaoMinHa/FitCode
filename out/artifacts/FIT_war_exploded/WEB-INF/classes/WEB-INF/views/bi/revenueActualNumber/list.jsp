...
function clickPage(page){
	...
	$("#Content").load("${ctx}/bi/revenueActualNumber/list",{pageNo:$("#PageNo").val(),pageSize:$("#PageSize").val(),
	...
	<tbody>
		<c:forEach items="${page.result}" var="mapping">
			<tr>
				...
				<td style="border-right:1px solid #eee;text-align: center;">${mapping.announcementRevenue}</td>
			</tr>
		</c:forEach>
	</tbody>
</table>
