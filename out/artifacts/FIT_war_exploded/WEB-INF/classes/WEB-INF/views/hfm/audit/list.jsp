...
function clickPage(page){
	...
	$("#Content").load("${ctx}/hfm/audit/list",{pageNo:$("#PageNo").val(),pageSize:$("#PageSize").val(),
														orderBy:$("#OrderBy").val(),orderDir:$("#OrderDir").val(),
														date:date,entity:entity,tableName:tableName},function(){$("#loading").fadeOut(1000);});
}
	...
	<table class="table table-condensed table-hover">
		...
		<tbody>
			<c:forEach items="${page.result}" var="mapping">
				<tr>
					<c:forEach var="i" begin="1" end="${fn:length(mapping)-1 }">
