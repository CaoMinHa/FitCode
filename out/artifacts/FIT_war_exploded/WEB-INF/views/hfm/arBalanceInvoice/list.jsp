...
function clickPage(page){
	...
	$("#Content").load("${ctx}/hfm/arBalanceInvoice/list",{pageNo:$("#PageNo").val(),pageSize:$("#PageSize").val(),
		...
		<tbody>
			<c:forEach items="${page.result}" var="mapping">
				<tr>
					...
					<td style="border-right:1px solid #eee;">${mapping.overdueDays}</td>
					...
					<td style="border-right:1px solid #eee;">${mapping.dueAging}</td>
