...
function clickPage(page){
	...
	$("#Content").load("${ctx}/hfm/apBalanceStorage/list",{pageNo:$("#PageNo").val(),pageSize:$("#PageSize").val(),
		...
		<tbody>
			<c:forEach items="${page.result}" var="mapping">
				<tr>
					...
					<td style="border-right:1px solid #eee;">${mapping.strikeNo}</td>
					<td style="border-right:1px solid #eee;">${mapping.number}</td>
					...
					<td style="border-right:1px solid #eee;">${mapping.srcUntaxAmount}</td>
