 ...
 */
@Controller
@RequestMapping("/bi/pmrIndustryOverview")
public class PmrSharePriceTradingVolumeController extends BaseController {
    ...
    private static String tableName="PMR_INDUSTRY_OVERVIEW";
    ...
    public String index(Model model, HttpServletRequest request) {
        ...
        return "/bi/pmrIndustryOverview/index";
    }
    ...
    public String list(Model model, PageRequest pageRequest, HttpServletRequest request,String queryCondition) {
        ...
        return "/bi/pmrIndustryOverview/list";
    }
