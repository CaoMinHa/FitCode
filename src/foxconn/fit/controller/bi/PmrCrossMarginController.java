 ...
 */
@Controller
@RequestMapping("/bi/pmrCrossMargin")
public class PmrCrossMarginController extends BaseController {
    ...
    private static String tableName="PMR_GROSS_MARGIN_33_FIT";
    ...
    public String index(Model model, HttpServletRequest request) {
        ...
        return "/bi/pmrCrossMargin/index";
    }
