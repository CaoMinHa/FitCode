 ...
 */
@Controller
@RequestMapping("/bi/pmrCashTurnover")
public class PmrCashTurnoverController extends BaseController {
    ...
    private static String tableName="PMR_CASH_TURNOVER";
    ...
    public String index(Model model, HttpServletRequest request) {
        ...
        return "/bi/pmrCashTurnover/index";
    }
    ...
    public String list(Model model, PageRequest pageRequest, HttpServletRequest request,String queryCondition) {
        ...
        return "/bi/pmrCashTurnover/list";
    }
