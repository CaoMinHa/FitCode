 ...
 */
@Controller
@RequestMapping("/bi/pmrRoeRoaRatio")
public class PmrRoeRoaRatioController extends BaseController {
    ...
    private static String tableName="PMR_ROE_ROA_RATIO";
    ...
    public String index(Model model, HttpServletRequest request) {
        ...
        return "/bi/pmrRoeRoaRatio/index";
    }
