 ...
 */
@Entity
@Table(name = "FIT_FORECAST_DETAIL_REV_SRC")
public class ForecastDetailRevenueSrc extends IdEntity {

	private static final long serialVersionUID = -6340420848724099549L;

	private String entity;// 法人
	private String makeEntity;// 法人
	...
	public ForecastDetailRevenueSrc() {
	}

	public ForecastDetailRevenueSrc(String entity,String makeEntity, String industry,
			...
			String quantityMonth11, String quantityMonth12,
			String revenueMonth1, String revenueMonth2, String revenueMonth3,
			String revenueMonth4, String revenueMonth5, String revenueMonth6,
			String revenueMonth7, String revenueMonth8, String revenueMonth9,
			String revenueMonth10, String revenueMonth11, String revenueMonth12) {
		this.entity = entity;
