 ...
 */
@Entity
@Table(name = "FIT_AP_Trade_Storage")
public class APTradeStorage extends IdEntity {
	...
	private String srcUntaxAmount;// 未稅額（原幣）
	private String currencyUntaxAmount;// 未稅額（本幣）
