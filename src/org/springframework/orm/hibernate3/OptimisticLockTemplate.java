...
import foxconn.fit.entity.base.OperationEntity;
 ...
 * of transactions. <b>Note that OptimisticLockTemplate will perform its own Session
...
public class OptimisticLockTemplate extends HibernateTemplate implements HibernateOperations {
	...
	/**
	 * Create a new OptimisticLockTemplate instance.
	 */
	public OptimisticLockTemplate() {
	}
	 ...
	 */
	public OptimisticLockTemplate(SessionFactory sessionFactory) {
	 ...
	 */
	public OptimisticLockTemplate(SessionFactory sessionFactory, boolean allowCreate) {
		setSessionFactory(sessionFactory);
	 ...
	 * <p>{@code OptimisticLockTemplate} is aware of a corresponding
	...
	/**
	 * Set the fetch size for this OptimisticLockTemplate. This is important for processing
	...
	/**
	 * Return the fetch size specified for this OptimisticLockTemplate.
	 */
	...
	/**
	 * Set the maximum number of rows for this OptimisticLockTemplate. This is important
	...
	/**
	 * Return the maximum number of rows specified for this OptimisticLockTemplate.
	 */
	...
	protected <T> T doExecute(HibernateCallback<T> action, boolean enforceNewSession, boolean enforceNativeSession)
		...
		if (existingTransaction) {
			logger.debug("Found thread-bound Session for OptimisticLockTemplate");
		}
		...
		try {
			...
			if (existingTransaction) {
				logger.debug("Not closing pre-bound Hibernate Session after OptimisticLockTemplate");
	...
	private void operationCheck(Object entity,Session session) throws HibernateException{
		if (entity instanceof OperationEntity) {
			OperationEntity oe=(OperationEntity) entity;
			
			String username = SecurityUtils.getLoginUsername();
			Date date=new Date();
			if(StringUtils.isEmpty(oe.getCreator())){
				oe.setCreator(username);
				oe.setCreateTime(date);
			}
			oe.setUpdator(username);
			oe.setUpdateTime(date);
		}
	}
