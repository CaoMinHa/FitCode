...
function clickPage(page){
	...
	$("#Content").load("${ctx}/bi/takeawayActualNumber/list",{pageNo:$("#PageNo").val(),pageSize:$("#PageSize").val(),
...
<table class="table table-condensed table-hover">
	<thead>
		<tr>
			...
			<th style="text-align: center;">外賣外賣金額</th>
		</tr>
	</thead>
	<tbody>
		<c:forEach items="${page.result}" var="mapping">
			<tr>
				...
				<td style="border-right:1px solid #eee;text-align: center;">${mapping.amount}</td>
			</tr>
		</c:forEach>
	</tbody>
</table>
